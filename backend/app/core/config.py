...
class Settings(BaseSettings):
    ...
    woocommerce_order_reconciliation_interval_seconds: int = Field(default=60, ge=15, le=3600, validation_alias=AliasChoices("WOOCOMMERCE_ORDER_RECONCILIATION_INTERVAL_SECONDS", "woocommerce_order_reconciliation_interval_seconds"))
