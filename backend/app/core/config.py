...
class Settings(BaseSettings):
    ...
    google_routes_project_id: str = Field(default="", validation_alias=AliasChoices("GOOGLE_ROUTES_PROJECT_ID", "google_routes_project_id"))
    google_routes_credentials_file: str = Field(default="", repr=False, validation_alias=AliasChoices("GOOGLE_ROUTES_CREDENTIALS_FILE", "google_routes_credentials_file"))
    google_routes_credentials_json: str = Field(default="", repr=False, validation_alias=AliasChoices("GOOGLE_ROUTES_CREDENTIALS_JSON", "google_routes_credentials_json"))
