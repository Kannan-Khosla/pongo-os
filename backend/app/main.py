...
from app.api.routes import allocations, auth, business_dashboard, cycle_counts, dashboard, fulfillments, health, import_jobs, insights, inventory, item_imports, items, locations, orders, picks, receipts, reports, routes, scanner, smart_buying, stock_movements, ui, woocommerce
...
def create_app() -> FastAPI:
    ...
    app.include_router(smart_buying.router, prefix="/api", dependencies=protected)
